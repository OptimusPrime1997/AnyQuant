 ...
 *
 */
public class ChoosingButton extends JButton {
	private Color BUTTON_COLOR1;
	private Color BUTTON_COLOR2;
	private Color BUTTON_ENTER_COLOR1;
	private Color BUTTON_ENTER_COLOR2;
//	private Color BUTTON_CHOOSING_COLOR1;
//	private Color BUTTON_CHOOSING_COLOR2;
	...
	public ChoosingButton(String text) {

		super(text);
		BUTTON_COLOR1 = new Color(180, 230, 250);
		BUTTON_COLOR2 = new Color(255, 250, 205);
		BUTTON_ENTER_COLOR1 = new Color(255, 250, 205, 179);
		BUTTON_ENTER_COLOR2 = new Color(180, 230, 250, 179);
//		BUTTON_CHOOSING_COLOR1 = colors.get(4);
//		BUTTON_CHOOSING_COLOR2 = colors.get(5);
		// 步骤1
	...
	protected void paintComponent(Graphics g) {
		...
		if (hover) {
			...
			g2d.clip(r2d2);
			GradientPaint gp2 = new GradientPaint(0.0F, 4.0F, BUTTON_ENTER_COLOR2, 0.0F, h / 2, BUTTON_ENTER_COLOR1,
					true);
			g2d.setPaint(gp2);
